        ...
        <tbody class="table-border-bottom-0">
          @foreach ($pengaduans as $pengaduan)
             <tr>
              ...
              <td>
                <a href="/verifikasi/tolak/{{ $pengaduan->id_pengaduan }}" class="badge bg-danger text-decoration-none">Tolak</a>
                <a href="/verifikasi/valid/{{ $pengaduan->id_pengaduan }}" class="badge bg-success text-decoration-none">Valid</a>
              </td>
             </tr>
